...
INTRO_MESSAGE = '''\
Добро пожаловать в бот для создания анимированных обложек! Здесь вы сможете создать анимированные \
обложки для карточек Ваших товаров. Отправьте команду /show_me_demo, чтобы увидеть примеры обложек.
